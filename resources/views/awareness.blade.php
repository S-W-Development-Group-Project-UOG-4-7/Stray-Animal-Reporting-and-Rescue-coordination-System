...
<html lang="en">
    <head>
        ...
        <style type="text/tailwindcss">
            ...
            .user-tag {
                @apply tag bg-gradient-to-r from-blue-600 to-blue-800 text-white;
            }

            .admin-tag {
                @apply tag bg-gradient-to-r from-yellow-600 to-yellow-800 text-white;
            }
            ...
            .login-content {
                @apply glass-effect rounded-2xl p-8 max-w-md w-full mx-4 text-center;
            }
    ...
    <body class="overflow-x-hidden text-white">
        ...
        <div id="loginRequired" class="login-required">
            <div class="login-content">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-full gradient-bg">
                    <i class="text-2xl text-white fas fa-lock"></i>
                </div>
                <h2 class="mb-4 text-2xl font-bold">Login Required</h2>
                <p class="mb-6 text-gray-300">
                    You need to be logged in to access the Awareness Corner. Please log in to share and view content.
                </p>
                <a href="{{ route('login') }}" class="primary-btn inline-block">
                    <i class="fas fa-sign-in-alt"></i>
                    Go to Login
                </a>
                <p class="mt-6 text-sm text-gray-400">
                    Don't have an account? <a href="{{ route('register') }}" class="text-cyan-400 hover:text-cyan-300">Sign up here</a>
                </p>
            </div>
        </div>
        ...
        <header class="fixed top-0 z-50 w-full" style="background: rgba(7, 19, 49, 0.85); backdrop-filter: blur(15px); border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <nav class="items-center hidden gap-1 lg:flex">
                        ...
                        <div id="userInfo" class="user-info hidden">
                            ...
                            <span class="text-sm font-medium" id="userName">Loading...</span>
                        </div>
            ...
            <div id="mobile-menu" class="hidden px-5 py-4 border-t lg:hidden" style="background: rgba(7, 19, 49, 0.95); border-color: rgba(255, 255, 255, 0.1);">
                <div class="space-y-2">
                    ...
                    <!-- Mobile User Info -->
                    <div id="mobileUserInfo" class="pt-3 mt-3 border-t border-white/10 hidden">
                        <div class="flex items-center gap-3 px-2 py-2 rounded-lg bg-white/5">
                            <div class="user-avatar" id="mobileUserAvatar">?</div>
                            <div>
                                <span class="text-sm font-medium" id="mobileUserName">Loading...</span>
        ...
        <div id="mainContent" class="hidden">
            ...
            <section id="posts" class="section-padding">
                <div class="container-custom">
                    ...
                    <!-- Posts Container -->
                    <div id="postsContainer" class="max-w-4xl mx-auto">
                    ...
                    <div class="pt-8 border-t border-white/10">
                        <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                            <p class="text-sm text-gray-400">
                                © <span id="current-year"></span> SafePaws Awareness Corner. All rights reserved.
                            </p>
                            <p class="text-sm text-gray-400">
        ...
        <script>
            ...
            // This section should be integrated with your team's authentication system
            ...
            async function checkAuthStatus() {
                try {
                    // ============================================
                    // INTEGRATION POINT: Replace this with your actual auth check
                    // ============================================
                    
                    // Option 1: If using Laravel sessions (recommended)
                    ...
                    const demoUsers = [
                        ...
                        { id: 4, name: 'Casey Smith' },
                        { id: 5, name: 'Riley Brown' }
                    ];
                    
                    // Check localStorage for demo user
                    const demoUserId = localStorage.getItem('demo_user_id');
                    if (demoUserId) {
                        const user = demoUsers.find(u => u.id == demoUserId);
                        if (user) {
                    ...
                    // For demo purposes, show login overlay
                    showLoginRequired();
                    return false;
                    // ============================================
            ...
            function updateUserUI() {
                if (currentUser && currentUserId) {
                    ...
                    if (mobileUserAvatar) mobileUserAvatar.textContent = currentUser.charAt(0).toUpperCase();
            ...
            // ============================================
            // DEMO LOGIN FUNCTIONS (Remove in production)
            // ============================================
            // These are for demonstration only. Replace with your team's actual login system
            window.demoLogin = function() {
                ...
                currentUser = randomUser.name;
                currentUserId = randomUser.id;
            ...
            window.demoLogout = function() {
                ...
                localStorage.removeItem('safePawsPosts'); // Clear demo posts too
                showLoginRequired();
            ...
            const initialPosts = [
                {
                    ...
                    comments: [
                        { id: 1, author: 'Mike Chen', authorId: 3, text: 'This is amazing! How can I start something similar in my area?', date: '1 day ago' },
                        { id: 2, author: 'Lisa Park', authorId: 4, text: 'We did this too! It really brings the community together.', date: '12 hours ago' }
                    ]
                },
                {
                    id: 2,
                    ...
                    media: {
                        type: 'youtube',
                        url: 'https://www.youtube.com/embed/dQw4w9WgXcQ' // Example YouTube embed
                    },
                    comments: [
                        { id: 1, author: 'David Miller', authorId: 6, text: 'Thank you for sharing this! The transformation is incredible.', date: '6 days ago' },
                        { id: 2, author: 'Emma Wilson', authorId: 7, text: 'This video made me cry. Thank you for your work!', date: '5 days ago' }
                    ]
                },
                {
                    id: 3,
                    ...
                    comments: [
                        { id: 1, author: 'Tom Harris', authorId: 8, text: 'What an amazing transformation! How did you gain her trust?', date: '2 days ago' },
                        { id: 2, author: 'Current User', authorId: 1, text: 'It took patience and lots of gentle interactions. Started with food, then gentle petting once she was comfortable.', date: '1 day ago' }
                    ]
                }
            ];
            ...
            function createPostElement(post) {
                ...
                // Create media HTML based on media type
                let mediaHTML = '';
                if (post.media) {
                ...
                div.innerHTML = `
                    ...
                    ${isPostOwner ? `
                        <div class="post-actions">
                            <button onclick="editPost(${post.id})" class="edit-btn">
                                    ...
                                    <div class="comment-card" id="comment-${comment.id}">
                                        ${isCommentOwner ? `
                                            <div class="absolute top-3 right-3 flex gap-2">
                                                <button onclick="editComment(${comment.id}, ${post.id})" class="edit-btn text-xs px-2 py-1">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button onclick="deleteComment(${comment.id}, ${post.id})" class="delete-btn text-xs px-2 py-1">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex justify-end mt-3">
                                <button onclick="addComment(${post.id})" 
                                        class="px-6 py-2 rounded-full gradient-bg text-white hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300">
            ...
            function addComment(postId) {
                ...
                commentElement.innerHTML = `
                    <div class="absolute top-3 right-3 flex gap-2">
                        <button onclick="editComment(${newComment.id}, ${postId})" class="edit-btn text-xs px-2 py-1">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="deleteComment(${newComment.id}, ${postId})" class="delete-btn text-xs px-2 py-1">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                    <div class="comment-header">
                ...
                const currentCount = posts[postIndex].comments.length;
                commentSection.textContent = `Comments (${currentCount})`;
            ...
            function editComment(commentId, postId) {
                if (!currentUser) {
                    showNotification('Please log in to edit comments');
                    return;
                }
                ...
                if (comment.authorId !== currentUserId) {
                    showNotification('You can only edit your own comments');
                    return;
                }
            ...
            function deleteComment(commentId, postId) {
                ...
                // Check ownership
                if (posts[postIndex].comments[commentIndex].authorId !== currentUserId) {
            ...
            function editPost(postId) {
                if (!currentUser) {
                    showNotification('Please log in to edit posts');
                    return;
                }
                ...
                if (post.authorId !== currentUserId) {
                    showNotification('You can only edit your own posts');
                    return;
                }
            ...
            function deletePost(postId) {
                if (!currentUser) {
                    showNotification('Please log in to delete posts');
                    return;
                }
            ...
            document.getElementById('uploadForm').addEventListener('submit', function(e) {
                ...
                if (!currentUser) {
                    showNotification('Please log in to share content');
                    return;
                }
                ...
                if (contentType === 'video') {
                    ...
                    if (youtubeUrl) {
                        ...
                        const videoFile = document.getElementById('contentFile').files[0];
                        if (videoFile) {
                    ...
                    const imageFile = document.getElementById('contentFile').files[0];
                    if (imageFile) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            newPost.media = {
            ...
            // Update post form based on content type
            document.querySelectorAll('input[name="contentType"]').forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    if (this.value === 'image') {
                        ...
                        fileInput.nextElementSibling.querySelector('span:last-child').textContent = 'Images up to 50MB';
                    } else if (this.value === 'video') {
                        fileInput.setAttribute('accept', '.mp4,.mov,.avi,.mkv');
                        fileInput.nextElementSibling.querySelector('span:last-child').textContent = 'Videos up to 50MB';
                    } else {
                        fileInput.setAttribute('accept', '.jpg,.jpeg,.png,.gif');
                        fileInput.nextElementSibling.querySelector('span:last-child').textContent = 'Images up to 50MB';
                    }
            ...
            document.getElementById('contentFile').addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    if (contentType === 'image') {
                        ...
                        validTypes = ['video/mp4', 'video/quicktime', 'video/x-msvideo', 'video/x-matroska'];
                    } else {
                        validTypes = ['image/jpeg', 'image/jpg', 'image/png', 'image/gif'];
                    }
                    
                    if (!validTypes.includes(file.type)) {
                        const typeName = contentType === 'image' ? 'image' : 'video';
                        alert(`Please select a valid ${typeName} file`);
                        this.value = '';
                        return;
                    }
                    ...
                    reader.onload = function(e) {
                        if (file.type.startsWith('video/')) {
                            ...
                            preview.innerHTML = `
                                <div class="relative">
                                    <img src="${e.target.result}" alt="Preview" class="w-full">
                                    <button type="button" onclick="removeMedia()" class="remove-image">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </div>
            ...
            document.getElementById('editPostForm').addEventListener('submit', function(e) {
                ...
                if (postIndex !== -1) {
                    ...
                    const postElement = document.getElementById(`post-${postId}`);
                    if (postElement) {
                        const titleElement = postElement.querySelector('h2.text-2xl');
            ...
            function updatePostCount() {
                ...
                // You could update a counter in the navigation if needed
            }
            ...
            document.addEventListener('DOMContentLoaded', async function() {
                ...
                // Add event listener for file drag and drop
        ...
        <!-- This is only for demonstration - your team's actual login will replace this -->
        <div class="fixed bottom-4 left-4 z-40 flex flex-col gap-2">
            <button onclick="demoLogin()" class="px-4 py-2 rounded-full gradient-bg text-white text-sm shadow-lg hover:shadow-cyan-500/30 transition-all duration-300">
                <i class="mr-2 fas fa-sign-in-alt"></i>Demo Login
            </button>
            <button onclick="demoLogout()" class="px-4 py-2 rounded-full bg-red-500 text-white text-sm shadow-lg hover:shadow-red-500/30 transition-all duration-300">
                <i class="mr-2 fas fa-sign-out-alt"></i>Demo Logout
            </button>
        </div>
    </body>
</html>