    ...
    <div class="mb-6">
        <form method="GET" action="{{ route('donation-history') }}" class="flex flex-wrap gap-3">
            ...
            <select name="payment_method" class="w-full px-4 py-3 text-black rounded-xl md:w-1/5">
                ...
                <option value="bank" {{ request('payment_method') == 'bank' || request('payment_method') == 'bank_transfer' ? 'selected' : '' }}>Bank Transfer</option>
            </select>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tr class="border-b border-white/5 hover:bg-white/5">
                    <td class="py-4 font-mono text-cyan-400">{{ 'DON-' . str_pad($donation->id, 6, '0', STR_PAD_LEFT) }}</td>
                    <td class="py-4">
