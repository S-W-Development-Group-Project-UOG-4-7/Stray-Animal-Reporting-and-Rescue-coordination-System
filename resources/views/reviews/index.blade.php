  ...
  <div class="grid gap-6 lg:grid-cols-2">
    ...
    <div class="rounded-3xl border border-white/10 bg-white/5 shadow-soft p-6">
      ...
      <form method="POST" action="/reviews" class="mt-6 space-y-4">
        ...
        <button class="w-full rounded-2xl bg-linear-to-r from-amber-500 to-pink-500 hover:from-amber-400 hover:to-pink-400 px-5 py-3 font-extrabold shadow-soft transition">
