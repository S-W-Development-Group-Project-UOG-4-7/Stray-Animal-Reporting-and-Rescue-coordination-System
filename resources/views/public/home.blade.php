                ...
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    <div class="stagger-animation">
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row">
                            ...
                            <a href="{{ route('adoption.index') }}" class="primary-btn animate-pulse-glow">
                                <i class="fas fa-heart"></i>
                                Adopt a Friend
                            </a>
        ...
        <section id="adopt" class="section-padding bg-gradient-to-b from-transparent to-cyan-900/10">
            <div class="container-custom">
                ...
                <div class="mt-12 text-center">
                    ...
                    <a href="{{ route('adoption.index') }}" class="primary-btn">
                ...
                <div class="grid gap-8 mb-12 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="{{ route('adoption.index') }}" class="text-gray-300 transition-colors duration-300 hover:text-cyan-400">Adopt a Pet</a></li>
                            <li><a href="{{ route('donation') }}" class="text-gray-300 transition-colors duration-300 hover:text-cyan-400">Donate</a></li>
                            <li><a href="{{ route('awareness') }}" class="text-gray-300 transition-colors duration-300 hover:text-cyan-400">Awareness Corner</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="{{ route('adoption.index') }}" class="text-gray-300 transition-colors duration-300 hover:text-cyan-400">Adoption Services</a></li>
                            ...
                            <li><a href="{{ route('awareness') }}" class="text-gray-300 transition-colors duration-300 hover:text-cyan-400">Education & Awareness</a></li>
                        </ul>
                    </div>
