        ...
        <div class="bg-white/5 p-8 rounded-xl border border-white/10">
            ...
            <div class="flex items-start justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-400">#ADP-{{ $adoption->id }}</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="border-b border-white/10 pb-3">
                        ...
                        <div class="text-lg text-white font-medium">{{ $adoption->full_name }}</div>
                    </div>

                    <div class="border-b border-white/10 pb-3">
                        <div class="text-sm text-gray-400 mb-1">Email</div>
                        <div class="text-lg text-white font-medium">{{ $adoption->email }}</div>
                    </div>

                    <div class="border-b border-white/10 pb-3">
                        <div class="text-sm text-gray-400 mb-1">Phone</div>
                        <div class="text-lg text-white font-medium">{{ $adoption->phone }}</div>
                    </div>

                    <div class="border-b border-white/10 pb-3">
                        <div class="text-sm text-gray-400 mb-1">Address</div>
                        <div class="text-lg text-white font-medium">{{ $adoption->address }}</div>
                    </div>

                    <div class="border-b border-white/10 pb-3">
                        <div class="text-sm text-gray-400 mb-1">Housing Type</div>
                        <div class="text-lg text-white font-medium">{{ $adoption->housing_type }}</div>
                    </div>

                    @if($adoption->reason)
                    <div class="border-b border-white/10 pb-3">
                        <div class="text-sm text-gray-400 mb-1">Reason for Adoption</div>
                        <div class="text-lg text-white font-medium">{{ $adoption->reason }}</div>
                    </div>
                    @endif
                </div>
            ...
            <div class="flex gap-4 flex-wrap">
                ...
                @elseif($adoption->status == 'Home Check Scheduled' || $adoption->status == 'Ready for Pickup' || $adoption->status == 'Approved')
                <form action="{{ route('rescue.adoptions.approve', $adoption->id) }}" method="POST" class="flex-1">
                    @csrf
