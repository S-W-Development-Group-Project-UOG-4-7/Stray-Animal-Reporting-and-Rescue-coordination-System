    ...
    <div class="max-w-4xl mx-auto px-5 py-8">
        ...
        <div class="bg-white/5 p-8 rounded-xl border border-white/10">
            ...
            <div class="flex items-start justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">{{ $report->animal_type ?? 'Animal Report' }}</h1>
                    <p class="text-gray-400">Report #{{ $report->report_id }}</p>
                </div>
            ...
            <div class="flex gap-4 flex-wrap">
                ...
                @if($report->animal)
                    <a href="{{ route('rescue.animals.show', $report->animal->id) }}" class="primary-btn flex-1 text-center bg-green-600 hover:bg-green-700">
                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @elseif(in_array($report->status, ['assigned', 'in_progress', 'rescued']))
                    <a href="{{ route('rescue.animals.createFromReport', $report->id) }}" class="primary-btn flex-1 text-center bg-purple-600 hover:bg-purple-700">
                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
